...
if __name__ == "__main__":
    ...
    executor.update_parameters(timeout_min=60*48, slurm_partition="Kathleen", slurm_array_parallelism=1024, cpus_per_task=1, mem_gb=14, slurm_additional_parameters={'exclude': 'kathleencpu[17]'}, job_name='YAHPO')
