...
class SKL_GB(AbstractRandomForest):
    ...
    def _predict(
        ...
        means_  = self._gb.predict(X)
        preds = []
        for estimator in self._gb.estimators_:
    ...
    def reset_model(self):
        self._gb = GradientBoostingRegressor(n_estimators =10, random_state=self.seed)
