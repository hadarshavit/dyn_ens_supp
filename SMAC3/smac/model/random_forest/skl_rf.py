...
class SKL_RF(AbstractRandomForest):
    ...
    def copy_model(self):
        return deepcopy(self._rf)

    def set_model(self, model):
        self._rf = model

    def reset_model(self):
        self._rf = RandomForestRegressor(n_estimators = 10, random_state=self.seed)
